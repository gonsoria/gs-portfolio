...
function LandingPage() {
    return (
        <>
            <Flex direction='column' textAlign={{ base: 'center', md: 'left' }} height='fit-content' width={{ base: '76vw', xxs: '90vw' }} mx='auto' py={{ xxs: 'calc(50vh - 213px)', xs: 'calc(50vh - 209px)', sm: 'calc(50vh - 202px)', md: 'calc(50vh - 202px)', lg: 'calc(50vh - 202px)' }} paddingTop={{ base: '20px' }} paddingBottom={{ base: '20px' }} >
                <AnimatedComponents />
            </Flex >
            <Flex justifyContent={{ base: 'center', xxs: 'space-between' }} width={{ base: '76vw', xxs: '90vw' }} mx={{ base: '12vw', xxs: '5vw' }} my='16px' flexWrap={{ base: 'wrap', xs: 'wrap' }} alignContent='center'>
